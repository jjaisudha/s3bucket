...
public class DataTransformer {
    ...
    public static final String INPUT_BUCKET_NAME = "s3-bucket-csv-files";


    public static final String OUTPUT_BUCKET_NAME = "s3-bucket-json-files";
            ...
            do {
                ...
                for (S3ObjectSummary objectSummary : inputFileObjects.getObjectSummaries()) {
                    ...
                    if (fileKey.endsWith(".txt")) {
                        ...
                        putObjectBasic(s3ClientForStudentBuckets,OUTPUT_BUCKET_NAME, fileKey, transformedFile);
     ...
     */
    private static void putObjectBasic(AmazonS3 s3Client, String bucketName, String fileKey, File transformedFile) {
